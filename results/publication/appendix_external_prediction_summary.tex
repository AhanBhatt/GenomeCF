\begin{tabular}{p{6.1cm}p{1.2cm}p{3.6cm}c}
\toprule
...
Shortcut Score vs AUROC leave-one-family-out advantage & Permutation p & 0.007 & 1,000 \\
Full GenomeCF profile vs AUROC leave-one-family-out advantage & Permutation p & 0.362 & 1,000 \\
\bottomrule
\end{tabular}
